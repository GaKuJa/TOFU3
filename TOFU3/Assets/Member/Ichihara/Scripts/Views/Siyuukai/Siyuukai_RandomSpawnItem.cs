...
public class Siyuukai_RandomSpawnItem : BaseSpawmStatus
{
    //フィールドに存在しているアイテムの総数
    ...
    //スポーンエリア(試遊会用)
    [SerializeField]
    private List<int> _spawnArea = new List<int>();
    //座標
    [SerializeField]
    private ReturnPosition _cs_returnPosition = null;
    //乱数を格納
    ...
    void SetItem()
    {
        ...
        {
            var spawnPos = _cs_returnPosition.SetPosition(_randomArea);
