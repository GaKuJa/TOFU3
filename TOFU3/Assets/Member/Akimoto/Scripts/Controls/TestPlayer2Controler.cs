...
public class TestPlayer2Controler : MonoBehaviour
{
    ...
    private void MoveInput()
    {
        ...
        if (Input.GetKeyDown("joystick 2 button 0") && state != MovementState.wallrunning)
            Jump();

        if (Input.GetKeyDown("joystick 2 button 1") && isGround)
        {
    ...
    private void StateHandler()
    {
        ...
        // 走り
        else if (isGround && Input.GetKey("joystick 2 button 8"))
        {
